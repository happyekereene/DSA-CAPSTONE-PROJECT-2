...
### Tools Used
---
1. Microsoft PowerBI Desktop [Download Here](https://www.microsoft.com/en-us/download/details.aspx?id=58494)
   * Data Cleaning
   * Data Analysis
   * Visualization
...
2.  Queries
   ...
   * Calculation of the "Bonus Amount" column

    Bonus Amount =
          'Palmoria Group emp-data'[Salary]*'Palmoria Group emp-data'[Bonus %]

   * Calculation of the "Total Amount" column
